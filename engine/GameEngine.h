...
void             graphics_clear(Palette_idx color);
...
void             graphics_drawLine(Point p1, Point p2, int width, Palette_idx color);
void             graphics_drawRect(Rect rect, Palette_idx color);
